...
if ($_GET['action'] == 'reset_password')
{
     ...
     if (mail($to, $subject, $body, $headers)) {
        ...
        echo "<div class=\"componentheading\">Forgot your Password?</div>\n";
...
<form action="/bstm/main/index.php?view=forgot_password&action=reset_password" method="post" class="josForm form-validate">
