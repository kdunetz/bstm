...
if ($_GET['category'] == 'store_restaurant')
{
   ...
   $fieldLabel = "Requested Store(s)/Restaurant(s)";
}
if ($_GET['action'] == 'add_product')
{
     $to = "bringsavingstome@gmail.com"; 
     ...
     $headers .= 'From: bringsavingstome@gmail.com' . "\r\n";
...
<form action="/bstm/main/index.php?view=request_catalog_update&action=add_product&category=<?php echo $_GET['category'] ?>" method="post" class="josForm form-validate">
