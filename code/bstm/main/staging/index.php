...
<!-- Begin Box 3 -->
<div class="module">
<script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="www.mlb.com" layout="button_count" show_faces="false" width="200"></fb:like>
</div>
<!--
			<div class="module">
			<div>
...
<?php
  ...
  if ($view == 'coupon' || $view == 'sale' || $view == 'sale_line_item' || $view == 'deal' || $view == 'my_savings' || $view == 'my_shopping_list' || $view == 'my_stores' || $view == 'my_coupons' || $view == 'user' || $view == 'request_catalog_update' || $view == 'best_price')
  {
     if (tep_session_is_registered('user_id')) 
     {
        ...
        else if (isset($_GET['view']) && ($_GET['view'] == 'best_price'))
        {
     ...
     else
     {
        ...
        echo "This content is restricted by login.  Please <a href=/bstm/main/staging/index.php?view=register&action=display>register</a> for an account to see this data";
     } 
  }
?>
<!--
