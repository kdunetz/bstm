...
<?php         if($this->params->get('ajaxvoting') == 1):
          ...
          <a href="<?php echo $url; ?>" onclick="<?php echo $onclick; ?>" class="jg_star_<?php echo $i; ?><?php echo JHTML::_('joomgallery.tip', JText::sprintf('JGS_DETAIL_RATING_STARS_TIPTEXT_VAR', $i, $this->maxvoting), JText::_('JGS_DETAIL_RATING_STARS_TIPCAPTION'), false, false) ?>">
            <?php echo $i; ?>
          </a>
<?php         else: ?>
          <a href="<?php echo $url; ?>" class="jg_star_<?php echo $i; ?> <?php echo JHTML::_('joomgallery.tip', JText::sprintf('JGS_DETAIL_RATING_STARS_TIPTEXT_VAR', $i, $this->maxvoting), JText::_('JGS_DETAIL_RATING_STARS_TIPCAPTION'), false, false) ?>">
            <?php echo $i; ?>
          </a>
<?php         endif; ?>
        </li>
