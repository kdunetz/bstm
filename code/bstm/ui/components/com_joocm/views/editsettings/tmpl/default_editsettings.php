...
<form action="index.php" method="post" id="josForm" name="josForm" class="form-validate">
	<div class="contentpane">
		<fieldset>
			<legend><?php echo JText::_('CM_MYSETTINGS'); ?></legend>
			...
			<table class="paramlist admintable" cellspacing="0" width="100%"><tbody><tr>
				<td class="paramlist_key" width="40%"><label for="time_format"><?php echo JText::_('CM_TIMEFORMAT'); ?></label></td>
				<td class="paramlist_value"><?php echo $this->lists['timeformats']; ?></td>
			</tr><tr>
				<td class="paramlist_key" height="40"><label for="show_online_state"><?php echo JText::_('CM_SHOWMYONLINESTATE'); ?></label></td>
				<td class="paramlist_value"><?php echo $this->lists['show_online_state']; ?></td>
			</tr><tr>
				<td class="paramlist_key" width="40%"><label for="show_email"><?php echo JText::_('CM_SHOWMYEMAIL'); ?></label></td>
				<td class="paramlist_value"><?php echo $this->lists['show_email']; ?></td>
			</tr><tr>
				<td class="paramlist_key" width="40%"><label for="signature"><?php echo JText::_('CM_SIGNATURE'); ?></label></td>
