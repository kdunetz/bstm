...
<form action="<?php echo $this->actionSearch; ?>" method="get" id="josForm" name="josForm" class="form-validate">	
	<div class="jbBoxTopLeft"><div class="jbBoxTopRight"><div class="jbBoxTop">
		<div class="jbTextHeader"><?php echo JText::_('BB_SEARCH'); ?></div>
	</div></div></div>
	<div class="jbBoxOuter"><div class="jbBoxInner">
		<div class="jbLeft jbWidth100">
			<fieldset class="jbMargin5">
				<legend class="jbLegend"><?php echo JText::_('BB_SEARCH'); ?></legend>
				<label for="searchwords" class="jbLabel"><?php echo JText::_('BB_SEARCHKEYWORDS'); ?></label>
				<input type="text" name="searchwords" id="searchwords" class="jbField jbInputBoxSearch required" size="30" value="<?php echo $this->searchWords; ?>" alt="<?php echo JText::_('BB_LABELSEARCHKEYWORDS'); ?>" />
			</fieldset>
			<button class="<?php echo $this->buttonSearch->class; ?> jbMargin5 validate" type="submit"><span><?php echo $this->buttonSearch->text; ?></span></button>
		</div>
		<br clear="all" />
	</div></div>
