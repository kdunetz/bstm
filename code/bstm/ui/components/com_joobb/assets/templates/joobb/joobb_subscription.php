...
<div class="jbRow jbPadding10 jbBorderTop jbBorderBottom">
	<div class="jbCol jbWidth55">
		<a href="<?php echo $this->subscription->subscriptionLink; ?>" class="jbLink">
			<img class="jbLeft jbPaddingRight10" src="<?php echo $this->joobbTemplate->themePathLive.DL.'images'.DL.'subscriptonDelete.png'; ?>" alt="<?php echo JText::_('BB_UNSUBSCRIBE'); ?>" />
		</a>
		<a href="<?php echo $this->subscription->href; ?>" title="<?php echo $this->subscription->subject; ?>" class="jbLink"> 
			<img class="jbLeft jbPaddingRight10" src="<?php echo $this->subscription->postIcon->fileName; ?>" alt="<?php echo $this->subscription->postIcon->title; ?>"  title="<?php echo $this->subscription->postIcon->title; ?>"/>
			<?php echo $this->subscription->subject; ?>
		</a><?php
		...
		echo ' '. JText::_('BB_ON') .' '. $this->subscription->date_topic; ?>
		</div>
	</div>
	...
	if (!empty($this->subscription->poster)) : 
		...
		echo JText::_('BB_ON').' '.$this->subscription->date_last_post; ?>
		<a href="<?php echo $this->subscription->lastPostLink; ?>">
			<img src="<?php echo $this->joobbTemplate->themePathLive.DL.'images'.DL.'latestPost.png'; ?>" alt="<?php echo JTEXT::sprintf('BB_GOTOLATESTPOST', $this->subscription->subject_last_post); ?>" title="<?php echo JTEXT::sprintf('BB_GOTOLATESTPOST', $this->subscription->subject_last_post); ?>" />
		</a><?php
	else :
		echo JText::_('BB_NOPOSTS');
	endif; ?>
	</div>
	<br clear="all" />
</div>