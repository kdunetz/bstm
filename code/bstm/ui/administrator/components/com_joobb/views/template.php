<?php
/**
 * @version $Id: template.php 177 2010-10-02 10:23:14Z sterob $
 * @package Joo!BB
	...
	function showTemplates(&$rows, $pageNav) {
		...
		<form action="index.php?option=com_joobb" method="post" name="adminForm">
			...
			for ($i=0, $n=count($rows); $i < $n; $i++) {
				...
				$alt_default = $row->default_template ? JText::_('BB_DEFAULT') :  JText::_('BB_NOTDEFAULT');				
		...
		<form action="index.php" method="post" name="adminForm">
			<div class="col width-50">
				<fieldset class="adminform">
					<legend><?php echo JText::_('BB_TEMPLATEDETAILS'); ?></legend>	
