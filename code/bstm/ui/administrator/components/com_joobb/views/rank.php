<?php
/**
 * @version $Id: rank.php 177 2010-10-02 10:23:14Z sterob $
 * @package Joo!BB
		...
		<form action="index.php?option=com_joobb" method="post" name="adminForm">
			...
			<thead><tr>
                ...
                <th nowrap="nowrap" width="30%">
                    <?php echo JHTML::_('grid.sort', 'BB_NAME', 'r.name', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joobb_rank_view'); ?>
                </th>
                <th nowrap="nowrap" width="60%">
                    <?php echo JHTML::_('grid.sort', 'BB_DESCRIPTION', 'r.description', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joobb_rank_view'); ?>
                </th>
                <th nowrap="nowrap" width="5%">
                    <?php echo JHTML::_('grid.sort', 'BB_MINPOSTS', 'r.min_posts', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joobb_rank_view'); ?>
                </th>									
                <th nowrap="nowrap" width="1%">
                    <?php echo JHTML::_('grid.sort', 'BB_PUBLISHED', 'r.published', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joobb_rank_view'); ?>
                </th>																													
                <th nowrap="nowrap" width="1%">
                    <?php echo JHTML::_('grid.sort', 'BB_ID', 'r.id', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joobb_rank_view'); ?>
                </th>			
			</tr></thead>
			<tfoot><tr>
	...
	function editRank(&$row, &$lists) { ?>
		...
		function submitbutton(pressbutton) {
			...
			if (trim(form.name.value) == "") {
				alert("<?php echo JText::sprintf('BB_MSGFIELDREQUIRED', JText::_('BB_NAME'), JText::_('BB_RANK')); ?>");
			} else {
		...
		<form action="index.php" method="post" name="adminForm">
			<div class="col width-50">
				<fieldset class="adminform">
					<legend><?php echo JText::_('BB_RANKDETAILS'); ?></legend>
					<table class="admintable" cellspacing="1"><tr>
                        ...
                        <td class="key">
                            <label for="rank_file">
                                <?php echo JText::_('BB_RANKIMAGEFILE'); ?>
                            </label>
                        </td>
                        <td>
