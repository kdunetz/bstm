		...
		<form action="index.php?option=com_joocm" method="post" name="adminForm">
			...
			<thead><tr>
                ...
                <th nowrap="nowrap" width="98%">
                    <?php echo JHTML::_('grid.sort', 'CM_NAME', 'l.name', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefieldlist_view'); ?>
                </th>
                <th nowrap="nowrap" width="1%">
                    <?php echo JHTML::_('grid.sort', 'CM_PUBLISHED', 'l.published', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefieldlist_view'); ?>
                </th>
                <th nowrap="nowrap" width="1%">
                    <?php echo JHTML::_('grid.sort', 'CM_ID', 'l.id', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefieldlist_view'); ?>
                </th>
			</tr></thead>
			<tfoot>
				<td colspan="5">
	...
	function editProfileFieldList(&$row, &$lists) {
		...
		function submitbutton(pressbutton) {
			...
			if (trim(form.name.value) == "") {
				alert("<?php echo JText::sprintf('CM_MSGFIELDREQUIRED', JText::_('CM_NAME'), JText::_('CM_PROFILEFIELDLIST')); ?>");
			} else {
		...
		<form action="index.php" method="post" name="adminForm" id="adminForm">
			<div class="col width-50">
				<fieldset class="adminform">
                    <legend>
                        <?php echo JText::_('CM_FIELDLISTDETAILS'); ?>
                    </legend>
