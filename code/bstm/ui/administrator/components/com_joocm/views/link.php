<?php
/**
 * @version $Id: link.php 132 2010-07-26 11:50:33Z sterob $
 * @package Joo!CM
		...
		<form action="index.php?option=com_joocm" method="post" name="adminForm">
			...
			<thead><tr>
                ...
                <th nowrap="nowrap" width="58%">
                    <?php echo JHTML::_('grid.sort', 'CM_NAME', 'l.name', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_link_view'); ?>
                </th>
                <th nowrap="nowrap" width="20%">
                    <?php echo JHTML::_('grid.sort', 'CM_COMPONENT', 'l.com', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_link_view'); ?>
                </th>
                <th nowrap="nowrap" width="20%">
                    <?php echo JHTML::_('grid.sort', 'CM_URL', 'l.url', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_link_view'); ?>
                </th>
                <th nowrap="nowrap" width="1%">
                    <?php echo JHTML::_('grid.sort', 'CM_PUBLISHED', 'l.published', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_link_view'); ?>
                </th>
                <th nowrap="nowrap" width="1%">
                    <?php echo JHTML::_('grid.sort', 'CM_ID', 'l.id', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_link_view'); ?>
                </th>
			</tr></thead>
			<tfoot>
				<td colspan="8">
	...
	function editLink(&$row, &$lists) {
		...
		function submitbutton(pressbutton) {
			...
			if (trim(form.name.value) == "") {
				alert("<?php echo JText::sprintf('CM_MSGFIELDREQUIRED', JText::_('CM_NAME'), JText::_('CM_LINK')); ?>");
			} else {
		...
		<form action="index.php" method="post" name="adminForm">
			<div class="col width-50">
				<fieldset class="adminform">
					<legend><?php echo JText::_('CM_LINKDETAILS'); ?></legend>		
					<table class="admintable" cellspacing="1"><tr>
						...
						<td class="key">
							<label for="published" title="<?php echo JText::_('CM_PUBLISHED') .'::'. JText::_('CM_LINKPUBLISHEDDESC'); ?>">
						...
						<td class="key">
							<label for="description">
								<?php echo JText::_('CM_REPLACEMENT'); ?>
							</label>
						</td><td>
