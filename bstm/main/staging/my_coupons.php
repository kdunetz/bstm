...
<textarea rows=6 cols=50 name=comments>" . $objects['comments'] . "</textarea></td>
  ...
  while ($objects = tep_db_fetch_array($objects_query)) 
  {
     ...
     echo "<tr><a name=\"" . $objects['my_coupons_id'] . "\"></a><td class=bstm_td><a href=index.php?view=my_coupons&action=delete&my_coupons_id=" . $objects['my_coupons_id'] . ">Delete</a><br><a href=index.php?view=my_coupons&action=display_edit_form&my_coupons_id=" . $objects['my_coupons_id'] . ">Edit</a>";
