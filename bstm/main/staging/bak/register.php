<?php 
  ...
  if (isset($_GET['action']) && ($_GET['action'] == 'process')) 
  {
    ...
    {
       $messageStack->add('Error Registering: User Name is a required field');
    }
    ...
    if (!empty($_POST['email_address'])) 
    {
     ...
     $password = base64_encode(sha1($password,true));
      ...
      echo "<div class=\"componentheading\">Registration</div>\n";
      echo "User Added Successfully.   You may login now";
      return;
  }
...
<tr>
	...
	<td>
		<input type="text" id="username" name="user_name" size="40" value="" class="inputbox required validate-username" maxlength="25" /> *
	</td>
</tr>
<tr>
	<td height="40">
...
<tr>
	...
	<td>
		<input class="inputbox required validate-passverify" type="input" id="zipcode" name="zipcode" size="15" value="" /> *
	</td>
</tr>
<tr>
	<td height="40">
