...
<a href=sale.php?action=display_edit_form&sale_id=" . $objects['sale_id']. "&redirect_url="; echo urlencode("sale.php?action=display&sale_id=" . $objects['sale_id'] . ""); echo "&sale_id=" . $objects['sale_id']; echo ">Edit</a><table width=100% border=1>
<tr>
  <td>Sale Id:</td>
  <td>" .  $objects['sale_id']  . "</td>
</tr>
<tr>
  <td>Sale Name: *</td>
...
";
echo "<br>
<a href=sale_line_item.php?action=display_create_form&redirect_url="; echo urlencode("sale.php?action=display&sale_id=" . $objects['sale_id'] . ""); echo "&sale_id=" . $objects['sale_id'] . ">Add Sale Line Item</a>";
  ...
  while ($objects = tep_db_fetch_array($objects_query)) 
  {
     ...
     echo "<tr><a name=\"" . $objects['sale_line_item_id'] . "\"></a><td><a href=sale_line_item.php?action=delete&sale_line_item_id=" . $objects['sale_line_item_id']. "&redirect_url="; echo urlencode("sale.php?action=display&sale_id=" . $objects['sale_id'] . ""); echo ">Delete</a><br><a href=sale_line_item.php?action=display_edit_form&sale_line_item_id=" . $objects['sale_line_item_id']. "&redirect_url="; echo urlencode("sale.php?action=display&sale_id=" . $objects['sale_id'] . ""); echo "&sale_id=" . $objects['sale_id']; echo ">Edit</a>";
