...
<tr>
  ...
  <td>" . sqlToUserDate( $objects['download_end_date'] ) . "</td>
</tr>
<tr>
  <td>Begin Date:</td>
...
<tr>
  <td>Buy This Deal</td>
  <td>" .  (strlen($objects['url']) > 0?"<a href=" . $objects['url']  . " TARGET=_new>Click Here</a>":"") . "</td>
</tr>
<tr>
  <td>Location:</td>
...
<tr>
  <td>Purchase/Download End Date: *</td>
  <td><input id=download_end_date name=download_end_date value=" . sqlToUserDate($objects['download_end_date']) . ">
...
<tr>
  <td>Begin Date:</td>
  <td><input id=begin_date name=begin_date value=" . sqlToUserDate($objects['begin_date']) . ">
...
<tr>
  <td>Original Amount: *</td>
  <td><input name=original_amount value=\"" . '' . "\"></td>
</tr>
<tr>
  <td>Savings: *</td>
