...
if ($_POST['source_id'] == 22 && empty($_POST['other_source_name'])) {
   $messageStack->add('You must enter the Other Source field if you choose Other for the Source Name');
}
 if ($messageStack->size > 0) { echo $messageStack->output(); return; }
...
/* NOW ADD TO MY COUPONS AUTOMATICALLY */
         $sql_data_array = array('creation_date' => 'now()',
                                 'created_by' => $user_id,
                                 'modification_date' => 'now()',
                                 'modified_by' => $user_id,
  ...
  if (isset($_GET['action']) && ($_GET['action'] == 'delete')) 
  {
     ...
     echo "<a href=coupon.php?action=delete_confirm&coupon_id=" . $_GET['coupon_id'] . $redirect_url_with_ampersand . ">Yes</a>";
     echo "<hr>";
     if (isset($_GET['redirect_url']))
     {
...
echo "<p>";
     if (tep_session_is_registered('user_id'))
     {
        ...
        {
           echo "<a class=\"button\" href=index.php?view=my_coupons><span>Back to Coupon List</span></a>";
        }
        echo "<a class=\"button\" href=index.php?view=coupon&action=select_coupon&coupon_id=" . $objects['coupon_id'] . "><span>Add Coupon to My Collection</span></a>";
        if (($role == 'admin' || $objects['user_id'] == $user_id) && strlen($objects['deal_id']) == 0) 
        {
           echo "<a class=\"button\" href=index.php?view=coupon&action=display_edit_form&coupon_id=" . $objects['coupon_id'] . "><span>Edit</span></a>\n";
           echo "<a class=\"button\" href=index.php?view=coupon&action=delete&coupon_id=" . $objects['coupon_id'] . "><span>Delete</span></a>\n";
        }
     }
//insertFaceBookLike("");
...
<tr>
  ...
  <td class=bstm_td>" .  $objects['other_source_name']  . "</td>
</tr>
<tr>
...
<tr>
  ...
  <td class=bstm_td><a href=" . (strpos($objects['url'], "http://") === false?"http://":"") .  $objects['url'] . ">" . $objects['url'] . "</a></td>
</tr>
<tr>
...
<tr>
  <td class=sectiontableheader>Coupon Name: *</td>
  <td class=bstm_td><input size=50 name=coupon_name value=\"" . '' . "\"></td>
</tr>
<tr>
  <td class=sectiontableheader>Begin Date:</td>
  <td class=bstm_td>
...
<tr>
  <td class=sectiontableheader>Other Source: (*)</td>
  <td class=bstm_td><input name=other_source_name></td>
</tr>
<tr>
  <td class=sectiontableheader>Delivery Mechanism: *</td>
  <td class=bstm_td>
...
<tr>
  <td class=sectiontableheader>Discount/Price Amount: *</td>
  <td class=bstm_td><input name=discount value=\"" . '' . "\"></td>
</tr>
<tr>
  <td class=sectiontableheader>Discount Units: *</td>
  <td class=bstm_td>
...
<tr>
  <td>Coupon Name: *</td>
  <td><input size=50 name=coupon_name value=\"" . $objects['coupon_name'] . "\"></td>
</tr>
<tr>
  <td>Begin Date:</td>
  <td>
