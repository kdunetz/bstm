...
'location5' => $_POST['location5'],
'keywords' => $_POST['keywords'],
'split_percent1' => $_POST['split_percent1'],
'split_percent2' => $_POST['split_percent2']
);
while(list($key,$value) = each($_POST)) {
  if (!isset($sql_data_array[$key]) && $key != 'action' && $key != 'redirect_url')
  {
...
/* KAD leave off the ending quotes because it is an equation on the end */
     ...
     echo "<div id=\"content\">
<a class=\"button\" href=" . $urlPrefix . "action=display_edit_form&user_id=" . $objects['user_id'] . "><span>Edit</span></a><table class=\"contenttoc\" width=100% border=1>
<tr>
  <td class=\"sectiontableheader\">First Name:</td>
  <td class=\"bstm_td\">" .  $objects['first_name']  . "</td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Last Name:</td>
  <td class=\"bstm_td\">" .  $objects['last_name']  . "</td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Email:</td>
  <td class=\"bstm_td\">" .  $objects['email']  . "</td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Email 2 (optional): </td>
  <td class=\"bstm_td\">" .  $objects['email2']  . "</td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Zip Code:</td>
  <td class=\"bstm_td\">" .  $objects['zipcode']  . "</td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Zone 1:</td>
  <td class=\"bstm_td\">" .  $objects['location']  . "</td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Zone 2:</td>
  <td class=\"bstm_td\">" .  $objects['location2']  . "</td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Zone 3:</td>
  <td class=\"bstm_td\">" .  $objects['location3']  . "</td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Zone 4:</td>
  <td class=\"bstm_td\">" .  $objects['location4']  . "</td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Zone 5:</td>
  <td class=\"bstm_td\">" .  $objects['location5']  . "</td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Keywords:</td>
  <td class=\"bstm_td\">" .  $objects['keywords']  . "</td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Savings Split Percent 1:</td>
  <td class=\"bstm_td\">" .  $objects['savings_split1']  . "</td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Savings Split Percent 2:</td>
  <td class=\"bstm_td\">" .  $objects['savings_split2']  . "</td>
</tr>
</table>
...
<tr>
  <td class=\"sectiontableheader\">First Name: *</td>
  <td class=\"bstm_td\"><input name=first_name value=\"" .  $objects['first_name']  . "\"></td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Last Name: *</td>
  <td class=\"bstm_td\"><input name=last_name value=\"" . $objects['last_name'] . "\"></td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Email: *</td>
  <td class=\"bstm_td\"><input name=email value=\"" . $objects['email'] . "\"></td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Email 2:</td>
  <td class=\"bstm_td\"><input name=email2 value=\"" . $objects['email2'] . "\"></td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Zip Code: *</td>
  <td class=\"bstm_td\"><input name=zipcode value=\"" .  $objects['zipcode']  . "\"></td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Zone 1: *</td>
  <td class=\"bstm_td\">
...
<tr>
  <td class=\"sectiontableheader\">Keywords:</td>
  <td class=\"bstm_td\"><textarea name=keywords></textarea></td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Savings Split Percent 1:</td>
  <td class=\"bstm_td\"><input name=savings_split1 value=" .  $objects['savings_split1']  . "></td>
</tr>
<tr>
  <td class=\"sectiontableheader\">Savings Split Percent 2:</td>
  <td class=\"bstm_td\"><input name=savings_split2 value=" .  $objects['savings_split2']  . "></td>
</tr>
</table>
