...
<?php 
  ...
  if (isset($_GET['action']) && ($_GET['action'] == 'process')) 
  {
     ...
     $other_location_name = tep_db_prepare_input($_POST['other_location_name']);
     ...
     $sql_data_array = array('creation_date' => 'now()',
                             ...
                             'modified_by' => $user_id,
                             'email' => $email_address,
                             'other_location_name' => $other_location_name,
                             'location' => $location);
...
<tr>
	...
	<td>
		<input type="text" id="other_location_name" name="other_location_name" size="40" value="" class="inputbox " maxlength="100" /> 
	</td>
</tr>
<tr>
