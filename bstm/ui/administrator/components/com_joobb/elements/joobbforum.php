...
class JElementJoobbForum extends JElement
{
	function fetchElement($name, $value, &$node, $control_name) {
		...
		if ($value) {
			...
			$joobbForum->name = JText::_('BB_SELECTFORUM');
		}
		...
		$html .= '<div class="button2-left"><div class="blank"><a class="modal" title="'.JText::_('BB_SELECTFORUM').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 650, y: 375}}">'.JText::_('BB_SELECT').'</a></div></div>'."\n";
