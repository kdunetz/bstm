<?php
/**
 * @version $Id: admin.joobb.php 134 2010-08-13 08:03:09Z sterob $
 * @package Joo!BB
...
if (!is_file(JPATH_SITE.DS.'components'.DS.'com_joocm'.DS.'include.php')) {
	...
	$app->redirect('index.php?option=com_installer', JText::_('BB_MSGJOOCMNOTINSTALLED'), 'notice');
}
...
<br />
<div align="center">
	<?php echo JText::_('BB_COPYRIGHT'); ?> &#169; 2007 - <?php echo date("Y"); ?> <a href="http://www.joobb.org" target="_blank"><?php echo JText::_('BB_JOOBBPROJECT'); ?></a> - <?php echo JText::_('BB_ALLRIGHTSRESERVED'); ?>
</div>