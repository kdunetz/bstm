		...
		<form action="index.php" method="post" name="adminForm" autocomplete="off">
			<div class="col width-50">
				<fieldset class="adminform">
					<legend><?php echo JText::_('BB_SITEMAP'); ?></legend>
					<table class="admintable" cellspacing="1"><tr>
						<td class="key">
							<label for="filename">
								<?php echo JText::_('BB_SITEMAPFILENAME'); ?>
							</label>
						</td><td>
						...
						<td class="key">
							<label for="changefreq">
								<?php echo JText::_('BB_CHANGEFREQUENCY'); ?>
							</label>
						</td><td>
