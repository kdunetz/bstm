		...
		<form action="index.php?option=com_joobb" method="post" name="adminForm">
			...
			<thead><tr>
				...
				<th nowrap="nowrap" width="45%">
					<?php echo JHTML::_('grid.sort', 'BB_FORUM', 'f.name', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joobb_forumelement_view'); ?>
				</th>
				<th nowrap="nowrap" width="40%">
					<?php echo JHTML::_('grid.sort', 'BB_CATEGORY', 'c.name', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joobb_forumelement_view'); ?>
				</th>
				<th nowrap="nowrap" width="1%">
					<?php echo JHTML::_('grid.sort', 'BB_STATUS', 'f.status', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joobb_forumelement_view'); ?>
				</th>										
				<th nowrap="nowrap" width="1%">
					<?php echo JHTML::_('grid.sort', 'BB_POSTS', 'f.posts', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joobb_forumelement_view'); ?>
				</th>
				<th nowrap="nowrap" width="1%">
					<?php echo JHTML::_('grid.sort', 'BB_TOPICS', 'f.topics', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joobb_forumelement_view'); ?>
				</th>																														
				<th nowrap="nowrap" width="1%">
					<?php echo JHTML::_('grid.sort', 'BB_ID', 'f.id', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joobb_forumelement_view'); ?>
				</th>			
			</tr></thead>
			<tfoot><tr>
