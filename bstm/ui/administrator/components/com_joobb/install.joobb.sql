...
INSERT INTO `#__joobb_configs` (`id`,`template`,`theme`,`emotion_set`,`icon_set`,`editor`,`topic_icon_function`,`post_icon_function`,`board_settings`,`latestpost_settings`,`feed_settings`,`view_settings`,`user_settings_defaults`,`attachment_settings`,`captcha_settings`,`parse_settings`,`checked_out`,`checked_out_time`) VALUES 
...
INSERT INTO `#__joobb_updates` (`version`,`update_file`,`status`) VALUES
 ('1.0.0 Phobos RC3','install.joobb.sql',1);
