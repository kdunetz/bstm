<?php
/**
 * @version $Id: config.php 172 2010-09-19 09:40:34Z sterob $
 * @package Joo!BB
...
class ControllerConfig extends JController
{
	...
	function showConfig() {
		...
		if (JTable::isCheckedOut($user->get('id'), $row->checked_out)) {
			...
			$this->setRedirect('index.php?option=com_joobb&task=joobb_config_view', JText::sprintf('BB_MSGBEINGEDITTED', JText::_('BB_CONFIG'), $row->name, $editingUser->name), 'notice'); return;
		}
	...
	function saveConfig() {
		...
		$msg = JText::sprintf('BB_MSGSUCCESSFULLYSAVED', JText::_('BB_CONFIG'), $row->name);
