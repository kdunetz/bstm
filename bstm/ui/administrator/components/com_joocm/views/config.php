<?php
/**
 * @version $Id: config.php 132 2010-07-26 11:50:33Z sterob $
 * @package Joo!CM
	...
	function showConfig(&$row, &$lists) {
		...
		function submitbutton(pressbutton) {
			...
			if (trim(form.name.value) == "") {
				alert("<?php echo JText::sprintf('CM_MSGFIELDREQUIRED', JText::_('CM_NAME'), JText::_('CM_CONFIG')); ?>");
			} else {
		...
		<form action="index.php" method="post" name="adminForm">
			<div class="col width-50">
				<fieldset class="adminform">
					<legend><?php echo JText::_('CM_CONFIGSETTINGS'); ?></legend>
			...
			<div class="col width-50">
				<fieldset class="adminform">
					<legend><?php echo JText::_('CM_REGISTRATIONUSERSETTINGSDEFAULTS'); ?></legend>
					<table class="admintable"><tr>
						<td><?php echo $lists['user_settings_defaults']->render('user_settings_defaults'); ?></td>
					</tr></table>
				</fieldset>
				<fieldset class="adminform">
					<legend><?php echo JText::_('CM_AVATARSETTINGS'); ?></legend>
					<table class="admintable"><tr>
						<td><?php echo $lists['avatar_settings']->render('avatar_settings'); ?></td>
					</tr></table>
				</fieldset>
				<fieldset class="adminform">
					<legend><?php echo JText::_('CM_CAPTCHASETTINGS'); ?></legend>
					<table class="admintable"><tr>
