<?php
/**
 * @version $Id: profilefield.php 132 2010-07-26 11:50:33Z sterob $
 * @package Joo!CM
		...
		<form action="index.php?option=com_joocm" method="post" name="adminForm">
			...
			<thead><tr>
                ...
                <th nowrap="nowrap" width="20%">
                    <?php echo JHTML::_('grid.sort', 'CM_NAME', 'p.name', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefield_view'); ?>
                </th>
                <th nowrap="nowrap" width="20%">
                    <?php echo JHTML::_('grid.sort', 'CM_TITLE', 'p.title', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefield_view'); ?>
                </th>
                <th nowrap="nowrap" width="20%">
                    <?php echo JHTML::_('grid.sort', 'CM_TYPE', 'p.type', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefield_view'); ?>
                </th>
                <th nowrap="nowrap" width="20%">
                    <?php echo JHTML::_('grid.sort', 'CM_PROFILEFIELDSET', 'profile_field_set_name', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefield_view'); ?>
                </th>
                <th nowrap="nowrap" width="5%">
                    <?php echo JHTML::_('grid.sort', 'CM_SIZE', 'p.size', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefield_view'); ?>
                </th>
                <th nowrap="nowrap" width="5%">
                    <?php echo JHTML::_('grid.sort', 'CM_LENGTH', 'p.length', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefield_view'); ?>
                </th>
                <th nowrap="nowrap" width="1%">
                    <?php echo JHTML::_('grid.sort', 'CM_PUBLISHED', 'p.published', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefield_view'); ?>
                </th>
                <th nowrap="nowrap" width="1%">
                    <?php echo JHTML::_('grid.sort', 'CM_REQUIRED', 'p.required', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefield_view'); ?>
                </th>
                <th nowrap="nowrap" width="8%">
                    <?php echo JHTML::_('grid.sort', 'CM_ORDER', 's.ordering, p.ordering', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefield_view'); ?>
                    <?php echo JHTML::_('grid.order', $rows, 'filesave.png', 'joocm_profilefield_saveorder' ); ?>
                </th>
                <th nowrap="nowrap" width="1%">
                    <?php echo JHTML::_('grid.sort', 'CM_ID', 'p.id', @$lists['filter_order_Dir'], @$lists['filter_order'], 'joocm_profilefield_view'); ?>
                </th>
			</tr></thead>
			<tfoot>
				<td colspan="12">
			...
			for ($i=0, $n=count( $rows ); $i < $n; $i++) {
				...
				$alt_required = $row->required ? JText::_('CM_REQUIRED') : JText::_('CM_NOTREQUIRED');
				...
				<tr class="<?php echo "row$k"; ?>">
					...
					<td class="order">
						<span><?php echo $pageNav->orderUpIcon($i, ($row->id_profile_field_set == @$rows[$i-1]->id_profile_field_set), 'joocm_profilefield_orderup', 'CM_ORDERUP', true); ?></span>
						<span><?php echo $pageNav->orderDownIcon($i, $n, ($row->id_profile_field_set == @$rows[$i+1]->id_profile_field_set), 'joocm_profilefield_orderdown', 'CM_ORDERDOWN', true); ?></span>
	...
	function editProfileField(&$row, &$lists) {
		...
		function submitbutton(pressbutton) {
			...
			if (trim(form.name.value) == "") {
				alert("<?php echo JText::sprintf('CM_MSGFIELDREQUIRED', JText::_('CM_NAME'), JText::_('CM_PROFILEFIELD')); ?>");
			} else {
		...
		<form action="index.php" method="post" name="adminForm">
			<div class="col width-50">
				<fieldset class="adminform">
					<legend><?php echo JText::_('CM_PROFILEFIELDDETAILS'); ?></legend>
					<table class="admintable" cellspacing="1"><tr>
						...
						<td class="key">
							<label for="description">
								<?php echo JText::_('CM_DESCRIPTION'); ?>
							</label>
						</td><td>
						...
						<td class="key">
							<label for="id_profile_field_set">
								<?php echo JText::_('CM_PROFILEFIELDSET'); ?>
							</label>
						</td>
						...
						<td class="key">
							<label for="id_profile_field_list">
								<?php echo JText::_('CM_PROFILEFIELDLIST'); ?>
							</label>
						</td>
			...
			<div class="col width-50">
				<fieldset class="adminform">
					<legend><?php echo JText::_('CM_VISUALAPPEREANCE'); ?></legend>
					<table class="admintable" cellspacing="1"><tr>
						<td class="key">
							<label for="length">
								<?php echo JText::_('CM_LENGTH'); ?>
							</label>
						</td><td>
