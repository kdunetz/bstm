...
class ControllerConfig extends JController
{
	...
	function showConfig() {
		...
		if (JTable::isCheckedOut($user->get('id'), $row->checked_out)) {
			...
			$this->setRedirect('index.php?option=com_joocm', JText::sprintf('CM_MSGBEINGEDITTED', JText::_('CM_CONFIG'), $row->name, $editingUser->name)); return;
		}
	...
	function saveConfig() {
		...
		$msg = JText::sprintf('CM_MSGSUCCESSFULLYSAVED', JText::_('CM_CONFIG'), $row->name);
