<?php
/**
 * @version $Id: joobb.php 135 2010-08-13 10:03:14Z sterob $
 * @package Joo!BB
...
class JoobbHelper
{
	...
	function getOrderByOptions() {
		...
		$orderByOptions[] = JHTML::_('select.option', 'ASC', JText::_('BB_ASCENDING'));
		$orderByOptions[] = JHTML::_('select.option', 'DESC', JText::_('BB_DESCENDING'));
	...
	function getSortByPostOptions() {
		...
		$sortByPostOptions[] = JHTML::_('select.option', 'author', JText::_('BB_AUTHOR'));
		$sortByPostOptions[] = JHTML::_('select.option', 'date_post', JText::_('BB_POSTTIME'));
		$sortByPostOptions[] = JHTML::_('select.option', 'subject', JText::_('BB_SUBJECT'));
