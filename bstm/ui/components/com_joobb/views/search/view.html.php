...
class JoobbViewSearch extends JView
{
	...
	function display($tpl = null) {
		...
		// handle page title
		$this->document->setTitle($this->joobbConfig->getBoardSettings('board_name') .' - '. JText::_('BB_SEARCH'));
		
		// handle metadata
		$this->document->setDescription(JText::sprintf('BB_SEARCHMETADESC', $this->joobbConfig->getBoardSettings('board_name')));
		$this->document->setMetadata('keywords', JText::_('BB_SEARCH'));
		
		// handle bread crumb
		$this->breadCrumbs->addBreadCrumb(JText::_('BB_SEARCH'), '');
