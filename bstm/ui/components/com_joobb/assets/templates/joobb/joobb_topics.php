...
<div class="jbMarginBottom10"><?php
	if ($this->buttonNewTopic) : ?>
		<a href="<?php echo $this->buttonNewTopic->href; ?>" class="<?php echo $this->buttonNewTopic->class; ?> jbLeft"><span><?php echo $this->buttonNewTopic->text; ?></span></a><?php
	endif; ?>
