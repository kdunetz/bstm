...
<div class="jbBoxTopLeft"><div class="jbBoxTopRight"><div class="jbBoxTop">
	<div class="jbTextHeader"><?php echo JText::_('BB_BOARDSTATISTICS'); ?></div>
</div></div></div>
<div class="jbBoxOuter"><div class="jbBoxInner">
	<div class="jbLeft jbMargin10">
		<div class="jbLeft"><?php echo JText::_('BB_TOTALTOPICS') . JText::_(': ') . $this->totalTopics; ?></div>
        <span class="jbLeft jbMarginLeft5 jbMarginRight5"><?php echo JTEXT::_('|'); ?></span>
        <div class="jbLeft"><?php echo JText::_('BB_TOTALPOSTS') . JText::_(': ') . $this->totalPosts; ?></div>
		<br />
        <div class="jbLeft"><?php echo JText::_('BB_TOTALMEMBERS') . JText::_(': ') . $this->totalMembers; ?></div>
        <span class="jbLeft jbMarginLeft5 jbMarginRight5"><?php echo JTEXT::_('|'); ?></span>
		<div class="jbLeft"><?php echo JText::_('BB_LATESTMEMBERS') . JText::_(': '); ?></div><?php
