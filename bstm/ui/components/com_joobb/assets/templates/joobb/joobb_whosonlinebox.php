...
<div class="jbBoxTopLeft"><div class="jbBoxTopRight"><div class="jbBoxTop">
	...
	if ($whosOnlineLink == '') : 
		echo JText::_('BB_WHOSONLINE'); 
	else : ?>
    	<a href="<?php echo $whosOnlineLink; ?>" class="jbTextHeader"><?php echo JText::_('BB_WHOSONLINE'); ?></a><?php 
	endif; ?>
    </div>
</div></div></div>
<div class="jbBoxOuter"><div class="jbBoxInner">
	<div class="jbLeft jbMargin10"><?php
		echo JText::_('BB_MEMBERSONLINE') . JText::_(': ') . $this->membersOnline; ?>
        <span class="jbMarginLeft5 jbMarginRight5"><?php echo JTEXT::_('|'); ?></span><?php
		echo JText::_('BB_GUESTSONLINE') . JText::_(': ') . $this->guestsOnline; ?>
		<br /><?php
