...
<div class="jbRow jbPadding10 jbBorderTop jbBorderBottom">
	...
	if ($this->forum->posts) : ?>
		<a href="<?php echo $this->forum->lastPostLink; ?>" title="<?php echo JTEXT::sprintf('BB_GOTOLATESTPOST', $this->forum->subject_last_post); ?>"><?php 
			echo substr($this->forum->subject_last_post, 0, 30).'...'; ?>
		</a>
		<a href="<?php echo $this->forum->lastPostLink; ?>" title="<?php echo JTEXT::sprintf('BB_GOTOLATESTPOST', $this->forum->subject_last_post); ?>">
			<img src="<?php echo $this->joobbTemplate->themePathLive.DL.'images'.DL.'latestPost.png'; ?>" alt="<?php echo JTEXT::sprintf('BB_GOTOLATESTPOST', $this->forum->subject_last_post); ?>" title="<?php echo JTEXT::sprintf('BB_GOTOLATESTPOST', $this->forum->subject_last_post); ?>"/>
		</a><br /><?php 
		if ($this->forum->authorLink) :
			echo JText::_('BB_BY'); ?>
			<a href="<?php echo $this->forum->authorLink; ?>"><?php echo ' '. $this->forum->author; ?></a><?php
		else :
			echo JText::_('BB_BY'); ?><span class="jbGuest"><?php echo ' '. $this->forum->author; ?></span><?php
		endif; ?>
		<br /><?php
		echo JText::_('BB_ON').' '.$this->forum->date_post;
	else :
