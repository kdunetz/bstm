...
<div class="jbRow jbPadding10 jbBorderTop jbBorderBottom">
	<div class="jbCol jbWidth55">
		...
		echo ' '. JText::_('BB_ON') .' '. $this->topic->date_topic; ?>
		</div>
	</div>
	...
	if (!empty($this->topic->poster)) : 
		...
		echo JText::_('BB_ON').' '.$this->topic->date_last_post; ?>
		<a href="<?php echo $this->topic->lastPostLink; ?>">
			<img src="<?php echo $this->joobbTemplate->themePathLive.DL.'images'.DL.'latestPost.png'; ?>" alt="<?php echo JTEXT::sprintf('BB_GOTOLATESTPOST', $this->topic->subject_last_post); ?>" title="<?php echo JTEXT::sprintf('BB_GOTOLATESTPOST', $this->topic->subject_last_post); ?>" />
		</a><?php
	else :
