...
<div class="jbBoxTopLeft"><div class="jbBoxTopRight"><div class="jbBoxTop">
	<div class="jbWidth55 jbTextHeader"><?php echo JText::_('BB_MYSUBSCRIBEDTOPICS'); ?></div>	
	<div class="jbWidth10 jbTextHeader" style="text-align: center;"><?php echo JText::_('BB_REPLIES'); ?></div>
	<div class="jbWidth10 jbTextHeader" style="text-align: center;"><?php echo JText::_('BB_VIEWS'); ?></div>	
	<div class="jbWidth20 jbTextHeader"><?php echo JText::_('BB_LASTPOSTS'); ?></div>
</div></div></div>
