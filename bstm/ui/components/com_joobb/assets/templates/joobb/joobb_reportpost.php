...
<form action="index.php" method="post" id="josForm" name="josForm" class="form-validate">
	<div class="jbBoxTopLeft"><div class="jbBoxTopRight"><div class="jbBoxTop">
		<div class="jbTextHeader"><?php echo JText::_('BB_REPORTPOST'); ?></div>
	</div></div></div>
	<div class="jbBoxOuter"><div class="jbBoxInner">
		<div class="jbLeft jbMargin5">
			<fieldset>
				<legend class="jbLegend"><?php echo JText::_('BB_REPORTPOST'); ?></legend>
				<?php echo JText::_('BB_REPORTPOSTABUSE'); ?><br /><br />
				<label for="report_comment" class="jbLabel"><?php echo JText::_('BB_COMMENT'); ?></label>
