...
// $Id: editcategory.php 2566 2010-11-03 21:10:42Z mab $
/****************************************************************************************\
**   JoomGallery  1.5.6                                                                 **
...
class JoomGalleryModelEditcategory extends JoomGalleryModel
{
  ...
  function store()
  {
    ...
    else
    {
      ...
      {
        $this->_mainframe->redirect(JRoute::_('index.php?view=showcategories', false), JText::_('You are not allowed to create more user categories'), 'notice');
      }
    }
