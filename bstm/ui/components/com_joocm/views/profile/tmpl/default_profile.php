...
<div class="cmProfile"><?php
    ...
    <div class="cmProfileView">
        ...
        <ul class="cmProfileDetails">
            <li class="title"><?php echo JTEXT::_('CM_EMAIL'); ?></li><li><?php echo $this->joocmUserView->get('email'); ?></li>
            <li class="title"><?php echo JTEXT::_('CM_USERGROUP'); ?></li><li><?php echo $this->joocmUserView->get('usertype'); ?></li>
            <li class="title"><?php echo JTEXT::_('CM_MEMBERSINCE'); ?></li><li><?php echo JoocmHelper::Date($this->joocmUserView->get('registerDate')); ?></li>
            <li class="title"><?php echo JTEXT::_('CM_LASTVISIT'); ?></li><li><?php echo JoocmHelper::Date($this->joocmUserView->get('lastvisitDate')); ?></li>
            <li class="title"><?php echo JTEXT::_('CM_PROFILEVIEWS'); ?></li><li><?php echo $this->joocmUserView->get('views_count'); ?></li>
        </ul>
    </div>
    <br clear="all" />
    <fieldset><?php 
    ...
    <br clear="all" />
    <input type="button" name="Cancel" class="button" onclick="history.back();" value="<?php echo JText::_('CM_BACK'); ?>" />
</div> 
<div class="cmProfileBox">
    <h3><?php echo JText::_('CM_ABOUTME'); ?></h3><?php
