...
<form action="index.php" method="post" id="josForm" name="josForm" class="form-validate" enctype="multipart/form-data">
	<div class="contentpane">
		<fieldset>
			<legend><?php echo JText::_('CM_MYACCOUNT'); ?></legend>
			<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr>
				...
				<td><input type="password" id="password" name="password" class="inputbox" size="40" value="" /><?php echo JText::_('CM_REQUIEREDASTERIX'); ?></td>
			</tr><tr>
				<td height="40"><label id="pw2msg" for="password2"><?php echo JText::_('CM_VERIFYPASSWORD'); ?>:</label></td>
				<td><input type="password" id="password2" name="password2" class="inputbox" size="40" value="" /><?php echo JText::_('CM_REQUIEREDASTERIX'); ?></td>
			</tr></table>
		</fieldset>
        <br clear="all" />
