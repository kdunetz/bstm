<?php
/**
 * @version $Id: joocm.php 133 2010-07-27 11:45:15Z sterob $
 * @package Joo!CM
...
class JoocmHelper
{
	...
	function getLink($function, $dynamicParams = '') {
		...
		return JRoute::_('index.php?option='.$link->com.$link->url.$dynamicParams.'&Itemid='.$Itemid, false);
	}
	...
	function getVersion($istallFile = '') {
		$version = JText::_('CM_UNKNOWNVERSION');
	...
	function getAvailableVersion($host = '', $versionFile = '', $timeOut = 5) {
		...
		if(@fsockopen($host, "80", $errno, $errstr, $timeOut)) {
			...
			$version = JText::_('CM_VERSIONHOSTNOTAVAILABLE');
		}
